...
public class ArrayDeque<T> {
    ...
    public void addFirst(T data) {
        if (data == null) {
            throw new IllegalArgumentException("Data is null and invalid. Please enter valid data.");
        }
    ...
    public T removeFirst() {
        if (size == 0) {
            throw new NoSuchElementException("Can't remove from front since deque is empty.");
        }
        T data = backingArray[mod(front, backingArray.length)];
    ...
    public T removeLast() {
        ...
        if (size == 0) {
            throw new NoSuchElementException("Last element does not exist since deque is empty.");
        }
    ...
    public T getFirst() {
        if (size == 0) {
            throw new NoSuchElementException("First element does not exist since deque is empty.");
        }
